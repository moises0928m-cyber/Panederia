...
export default function Footer() {
  const socialLinks = [
    {
      href: "https://www.facebook.com/groups/167875237196560",
      svg: (
    ...
    {
      href: "https://www.instagram.com/panaderia_argentino_felix/",
      svg: (
    ...
    {
      href: "https://www.youtube.com/@BreadChronicles",
      svg: (
        <svg
          viewBox="0 0 24 24"
          fill="none"
  ...
  return (
    <footer className="bg-[#98644F] py-6 px-4 text-white">
      <div className="container mx-auto max-w-7xl flex flex-col space-y-6">
        <div className="flex flex-col md:flex-row w-full items-center justify-between">
          ...
          <div className="w-full md:w-1/3 text-center md:text-left order-3 md:order-1 py-2">
            <p className="text-lx">
              © {new Date().getFullYear()} Pan De Los Ultimos Dias.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/3 text-center md:text-right order-2 md:order-3">
            ...
            <div className="text-sm space-y-1">
              ...
              <p>Email: contact@panultimosdias.com</p>
            </div>
          </div>
        </div>
      </div>
